...
def train_and_save_model(X_train, y_train, X_val, y_val, model_name, epochs=100, batch_size=32,
                         learning_rate=0.0001):
    model_directory = "../../models/standard_model"
    model_path = os.path.join(model_directory, f"{model_name}.h5")  # .h5 Erweiterung hinzufügen
    ...
    model.save(model_path)  # Speichern mit .h5 Erweiterung
...
if __name__ == "__main__":
    ...
    train_and_save_model(X_train, y_train, X_val, y_val, model_name="sol_standard_model")
