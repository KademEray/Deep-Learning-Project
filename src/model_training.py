...
# Modelltraining und -speicherung
def train_and_save_model(X_train, y_train, X_val, y_val, model_name, optimizer='adam', epochs=100, batch_size=32, learning_rate=0.0001):
    model = Sequential()
    ...
    model.save(os.path.join(model_directory, f"{model_name}"))
...
if __name__ == "__main__":
    ...
    train_and_save_model(X_train, y_train, X_val, y_val, model_name="lstm_standard_model")
