# Experiment 6: Erweiterte hybride Transformer-LSTM-Architektur für Bitcoin-Kursprognose

## **Kurzbeschreibung**
Das sechste Experiment baut auf den Stärken der hybriden Transformer-LSTM-Architektur auf und erweitert sie durch zusätzliche Indikatoren, optimierte Attention-Mechanismen und verbesserte Trainingsstrategien, um die Genauigkeit der Bitcoin-Kursprognose weiter zu steigern.
...
### **Erweiterte Indikatoren in Experiment 6**
...
Das Modell in Experiment 6 erweitert die hybride Architektur aus Experiment 5 durch optimierte Attention-Mechanismen, zusätzliche Indikatoren und erweiterte Feature-Fusion, um die Leistung bei der Vorhersage hochvolatiler Bitcoin-Kursbewegungen weiter zu steigern.
...
Das Testskript in **Experiment 6** umfasst die folgenden Schritte und Verbesserungen:
...
### **Dateien**
- **`experiment_6_data_processing.py`**:
...
# Datenverarbeitung
python experiment_6_data_processing.py
# Ergebnis: Generiert die vorbereiteten Sequenzen in ./Data/Samples/

# Training des Modells
python experiment_6_model.py
# Ergebnis: Trainiert das Modell und speichert es unter ./Data/Models/fusion_model_v6.pth
...
python experiment_6_tensorboard.py

# Netron: Zeigt die Modellarchitektur an
python experiment_6_netron.py

# TorchViz: Visualisiert den Datenfluss durch das Modell
python experiment_6_torchviz.py
...
### **Änderungen im Vergleich zu Experiment 5**
