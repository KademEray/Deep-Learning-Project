...
def train_and_save_model(X_train, y_train, X_val, y_val, model_name, output_steps, epochs=200, batch_size=256, learning_rate=0.0001):
    model_directory = "../../models/no_indicators_model"
...
if __name__ == "__main__":
    model_directory = "../../models/no_indicators_model"
    model_name = "sol_no_indicators_model"
    model_path = os.path.join(model_directory, f"{model_name}.h5")
    ...
    if retrain:
        ...
        data_directories = ["../../data/sol_without_indicators"]
        data_files = []
        ...
        train_and_save_model(X_train, y_train, X_val, y_val, model_name="sol_no_indicators_model", output_steps=30)
