...
if __name__ == "__main__":
    model_directory = "../../models/no_indicators_model"
    model_name = "btc_no_indicators_model"
    model_path = os.path.join(model_directory, f"{model_name}.h5")
    ...
    if retrain:
        ...
        data_directories = ["../../data/btc_without_indicators"]
        data_files = []
        ...
        train_and_save_model(X_train, y_train, X_val, y_val, model_name="btc_no_indicators_model", output_steps=30)
